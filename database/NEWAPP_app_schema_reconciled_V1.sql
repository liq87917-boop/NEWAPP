...
Generated at 2026-09-24T12:17:55.431555Z by tests/schema/ddl_reconciliation.py (NEWAPP-005).
Planned DDL contract: docs/NEWAPP_Database_DDL_V1.sql sha256 23211dfd77dc6f9baaf9653e2bf314719fe713d0a1a7d8f3860e9e748baf7f81
Accepted shared-key map: .ai/generated/NEWAPP-003-newerp-schema-map.json sha256 20e3730c31445f1c428a5e0f301146dc6e7424a57ba606f9d033f73fc21353eb

This file is additive and idempotent: 20 app tables, each creation guarded by an OBJECT_ID or NOT EXISTS check, 21 column declarations raised to the recorded shared key type.
Retyped keys: CustomerKey -> BIGINT (db_owner.BaseCustomers.Id), SupplierKey -> BIGINT (db_owner.BaseSuppliers.Id), UserKey -> BIGINT (db_owner.SysUsers.Id), SalesUserKey -> BIGINT (shared key type recorded by NEWAPP-003), CreatedByUserKey -> BIGINT (db_owner.SysUsers.Id), UpdatedByUserKey -> BIGINT (db_owner.SysUsers.Id), UploadedByUserKey -> BIGINT (db_owner.SysUsers.Id), SubmittedByUserKey -> BIGINT (db_owner.SysUsers.Id), RequestedByUserKey -> BIGINT (db_owner.SysUsers.Id), CorrectedByUserKey -> BIGINT (db_owner.SysUsers.Id), ChangedByUserKey -> BIGINT (db_owner.SysUsers.Id)
Kept neutral on purpose: SalesGroupKey NVARCHAR(80), TargetGroupKey NVARCHAR(80), TemplateKey NVARCHAR(80), TenantId UNIQUEIDENTIFIER
...
BEGIN
    CREATE TABLE app.UserMobileProfile(
        UserKey BIGINT NOT NULL CONSTRAINT PK_app_UserMobileProfile PRIMARY KEY,
...
BEGIN
    CREATE TABLE app.InviteCode(
        ...
        CreatedByUserKey BIGINT NOT NULL,
...
BEGIN
    CREATE TABLE app.InquiryRevision(
        ...
        SubmittedByUserKey BIGINT NOT NULL,
...
BEGIN
    CREATE TABLE app.AICorrection(
        ...
        CorrectedByUserKey BIGINT NOT NULL,
...
BEGIN
    CREATE TABLE app.ExportJob(
        ...
        TenantId UNIQUEIDENTIFIER NOT NULL,
        RequestedByUserKey BIGINT NOT NULL,
